...
docker compose -f docker-compose.yml -f docker-compose.dev.yml "${GPU_FLAGS[@]}" build --no-cache

echo ""
echo "Käivitan ARENDUS-režiimis..."
docker compose -f docker-compose.yml -f docker-compose.dev.yml "${GPU_FLAGS[@]}" up -d
